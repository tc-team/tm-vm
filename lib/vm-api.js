...
var target_router = require('./vm-api/routes/Target');
var tile_router = require('./vm-api/routes/Tile');
...
router.get('/target/:id', target_router.readTarget);
...
router.get('/tile/:zoom/:x/:y/:type', tile_router.readTile);
router.get('/map/:mapType/:zoom/:imgName', tile_router.readTileImg);
router.get('/tile/:zoom/:x/:y/:width/:height/:type', tile_router.readTiles);
