Polymer({
	...
	toggleEmail: function () {
		if (this.$.changeEmailIcon.icon === "create") {
			this.$.changeEmailIcon.icon = "expand-less";
		} else {
			this.$.changeEmailIcon.icon = "create";
		}
	...
	togglePayment: function () {
		if (this.$.changeBallanceIcon.icon === "expand-more") {
			this.$.changeBallanceIcon.icon = "expand-less";
		} else {
			this.$.changeBallanceIcon.icon = "expand-more";
		}
	...
	handleResGetMemoPrice: function (event, res) {
		this.memoPrice = res.response.product_price;
	}
});